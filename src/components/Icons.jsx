...
const paths = {
  ...
  badgeCheck: (
    <>
      <path d="m12 3 2.2 1.6 2.7-.3 1 2.5 2.3 1.4-.9 2.6.9 2.6-2.3 1.4-1 2.5-2.7-.3L12 20.8l-2.2-1.6-2.7.3-1-2.5-2.3-1.4.9-2.6-.9-2.6 2.3-1.4 1-2.5 2.7.3L12 3Z" />
      <path d="m9.2 12 1.9 1.9 3.7-3.8" />
    </>
  ),
  sparkles: (
    <>
      <path d="M11 3.5 12.5 7.8 16.8 9.3 12.5 10.8 11 15.1 9.5 10.8 5.2 9.3 9.5 7.8 11 3.5Z" />
      <path d="M18.2 14.4 19 16.6 21.2 17.4 19 18.2 18.2 20.4 17.4 18.2 15.2 17.4 17.4 16.6 18.2 14.4Z" />
      <path d="M5.6 14.6 6.2 16.3 7.9 16.9 6.2 17.5 5.6 19.2 5 17.5 3.3 16.9 5 16.3 5.6 14.6Z" />
    </>
  ),
  clipboard: (
    <>
